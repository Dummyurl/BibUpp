package com.bibupp.androidvantage.dialogs;
...
public class ProfileReportDialog  extends DialogFragment implements Constants {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        b.setTitle(getText(R.string.action_profile_report));

        /** Setting items to the alert dialog */
        b.setSingleChoiceItems(profile_report_categories, position, null);
