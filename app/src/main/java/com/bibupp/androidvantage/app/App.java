package com.bibupp.androidvantage.app;
...
import com.bibupp.androidvantage.util.LruBitmapCache;
...
public class App extends Application implements Constants {
    ...
    private String username, fullname, email, accessToken, photoUrl, coverUrl, gcmToken = "";
    private long id;
    ...
    public Boolean authorize(JSONObject authObj) {
        ...
        try {
            ...
            if (accountArray.length() > 0) {
                ...
                this.setCoverUrl(accountObj.getString("normalCoverUrl"));
            }
