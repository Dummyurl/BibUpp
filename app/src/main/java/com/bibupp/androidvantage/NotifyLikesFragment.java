...
public class NotifyLikesFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener, AnswerInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_notify_likes, container, false);
...
//                            Toast.makeText(getApplicationContext(), response.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void loadingComplete() {
        ...
        if (itemsAdapter.getCount() == 0) {
            ...
            if (NotifyLikesFragment.this.isVisible()) {
